...
let form_buttons = document.getElementById('form');
...
function addToCart(event){
    ...
    <td><button class="uk-button uk-button-danger btn btn-danger" type="button">Remove</button></td>
`
...
// adding functionality to purchase button 
function myfirstfunction() {
    form_buttons.style.display = "block"
    alert("Thanks For The Patronage, Looking Foward To See You Next Time, And Don`t Forget To Drop The Required Info ");
